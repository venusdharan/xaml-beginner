...
#include "App.g.hpp"
#include "ExpeditePage.g.hpp"
#include "MainPage.g.hpp"
#include "OrderPage.g.hpp"
...
::Windows::UI::Xaml::Markup::IXamlType^ ::XamlTypeInfo::InfoProvider::XamlTypeInfoProvider::CreateXamlType(::Platform::String^ typeName)
{
    ...
    if (typeName == L"RestaurantManager.ExpeditePage")
    {
        ...
        userType->Activator =
            []() -> Platform::Object^ 
            {
                return ref new ::RestaurantManager::ExpeditePage(); 
            };
        userType->SetIsLocalType();
        return userType;
    }

    if (typeName == L"RestaurantManager.MainPage")
    {
        ::XamlTypeInfo::InfoProvider::XamlUserType^ userType = ref new ::XamlTypeInfo::InfoProvider::XamlUserType(this, typeName, GetXamlTypeByName(L"Windows.UI.Xaml.Controls.Page"));
        userType->KindOfType = ::Windows::UI::Xaml::Interop::TypeKind::Custom;
        userType->Activator =
            []() -> Platform::Object^ 
            {
                return ref new ::RestaurantManager::MainPage(); 
            };
        userType->SetIsLocalType();
        return userType;
    }

    if (typeName == L"RestaurantManager.OrderPage")
    {
        ::XamlTypeInfo::InfoProvider::XamlUserType^ userType = ref new ::XamlTypeInfo::InfoProvider::XamlUserType(this, typeName, GetXamlTypeByName(L"Windows.UI.Xaml.Controls.Page"));
        userType->KindOfType = ::Windows::UI::Xaml::Interop::TypeKind::Custom;
        userType->Activator =
            []() -> Platform::Object^ 
            {
                return ref new ::RestaurantManager::OrderPage(); 
            };
        userType->SetIsLocalType();
        return userType;
    }
